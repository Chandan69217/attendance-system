...
import { markAsReadNotification } from "@/service/notification.service"
          ...
          >
            <CardContent className="flex items-start gap-4 p-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-xs text-muted-foreground/70">{new Date(notif.created_at || '').toLocaleDateString("en-US", { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" })}</p>
              </div>
            </CardContent>
          </Card>
        ))}
