  ...
  return (
    ...
    <div className="flex min-h-svh items-center justify-center bg-muted p-4">
      <div className="flex w-full max-w-[960px] flex-col items-center gap-8 lg:flex-row lg:gap-16">
        ...
        {
          showForgot ? <div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
            ...
            {onBack && (
              <Button
                ...
                className="mb-4 gap-2 self-start text-muted-foreground hover:text-foreground"
              >
            ...
            <p className="max-w-md text-lg leading-relaxed text-muted-foreground">
              No worries! Reset your password securely in just a few simple steps and regain access to your AttendAI account.
            </p>
